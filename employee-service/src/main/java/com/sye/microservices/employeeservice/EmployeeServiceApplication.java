package com.sye.microservices.employeeservice;
...
import com.sye.microservices.employeeservice.domain.Employee;
import com.sye.microservices.employeeservice.repository.EmployeeRepository;
...
public class EmployeeServiceApplication {
	...
	public Docket swaggerPersonApi10() {
		return new Docket(DocumentationType.SWAGGER_2)
				.select()
					.apis(RequestHandlerSelectors.basePackage("com.sye.microservices.employeeservice.controller"))
